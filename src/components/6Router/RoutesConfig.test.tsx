...
describe("Routes config tests", () => {
  ...
  it("Should load the Post component on post route", () => {
    ...
    // This test was throwing a testing error due to the mock implementation of the Request object because there is a jest error saying it does not find the request library.
